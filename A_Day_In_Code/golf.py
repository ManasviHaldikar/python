#Miniature golf program
from random import randint

def eagle():
    # Each value of the dictionary is initialized as an empty list
    scores= {'Player 1': [], 'Player 2': [], 'Player 3':[], 'Player 4':[]}

    # Add  18 randomly chosen numbers to each dictionary value (a list)
